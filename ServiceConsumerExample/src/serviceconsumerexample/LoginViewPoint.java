	...
	public LoginViewPoint(BundleContext context) {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Employee emp = ise.GET_EMPLOYEE(textField_1.getText(), textField.getText());
				...
				if (emp == null) {
					...
					if (emp.getRole().compareTo("Legal Stuff") == 0) {
						...
						LegalStaffViewPoint lsvp = new LegalStaffViewPoint(context);
						lsvp.setVisible(true);
						 dispose();
					...
					if (emp.getRole().compareTo("Receptionist") == 0) {
						...
						ReceptionistViewPoint rvp = new ReceptionistViewPoint(context);
						rvp.setVisible(true);
						 dispose();
						// ReceptionistViewPoint res = new
						// ReceptionistViewPoint();
						// res.setVisible(true);
					}
					 if (emp.getRole().compareTo("Head Office Management")==0){
						 System.out.println("Head Office Management");
						 HeadOfficeManagementViewPoint homv = new HeadOfficeManagementViewPoint(context);
						 homv.setVisible(true);
						 dispose();
						 
						 
					 }
					// HeadOfficeManagementViewPoint res = new
					// HeadOfficeManagementViewPoint();
					// res.setVisible(true);
					// }
				}
			}
